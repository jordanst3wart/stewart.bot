...
date: '2024-2-21'
tags: ['go','developer experience','golang']
draft: false
summary: 'Go has an amazing developer experience from a lot of it's tooling'
---

I find the development process of TypeScript painful in every step of development. I find the TypeScript language good, but I find everything around the language bad.

In comparsion, I find the Go language from easy in basically every aspect (Check my other most...).

You can experience this headache by simply racing to setup a basic webserver as you go threw most steps quickly. So here we go...
