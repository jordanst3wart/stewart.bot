...
It blows my mind that you can have a single folder `my_stuff` as the namespace folder. I learn the importance of jdk namespaces from Rich Hickey. It's really important to not have namespaces leak out into the system, and it's easier. So It's surprising to see this.

But if a well used build tools recommends this approach we might be able to skip at least some of the long spaces you see. Such as you can see in enterprise buzzfizz here: https://github.com/EnterpriseQualityCoding/FizzBuzzEnterpriseEdition/tree/uinverse/src/main/java/com/seriouscompany/business/java/fizzbuzz/packagenamingpackage/interfaces/parameters

The standard layout of JDK projects is the maven layout, which you can find here:
